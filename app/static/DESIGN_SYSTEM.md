...
| px | face | used for |
|---|---|---|
| 18 | Archivo | body prose, labels, buttons, form fields, list items |
| 19 | Archivo | step titles, card captions |
| 20 | **Courier** | every kicker, state mark, count, badge, path, cost note |
| 22 | Archivo | the logline |
