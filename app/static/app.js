      ...
      try {
        ...
        report.innerHTML = `<div class="report">
          ...
          <textarea data-f="prompt-edit" spellcheck="false"
            style="width:100%;min-height:300px;font-family:Consolas,monospace;font-size:14px"></textarea>
    ...
    $("[data-f=prose]", card).onclick = async (e) => {
      ...
      try {
        ...
        box.innerHTML = `
          ...
          <textarea data-f="prose-text" style="width:100%;min-height:240px;font-family:Consolas,monospace;font-size:14px"></textarea>
          <div class="row" style="margin-top:8px">
