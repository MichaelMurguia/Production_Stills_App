...
**2506 tests** across 131 files.


## Product app — 2285 tests in 114 files
...
| `test_the_anchor_row_shows_what_was_chosen.py` | 21 | The anchor cards wear the look they were set to. |
