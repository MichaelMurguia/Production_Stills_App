...
**2697 tests** across 137 files.


## Product app — 2476 tests in 120 files
...
| `test_a_subject_has_a_profile_and_two_doors.py` | 45 | A subject carries a profile, and two ways to get a picture. |
...
| `test_cast_is_a_row_and_a_screen.py` | 21 | Step 03 is a row on the stage, and the cast is a screen. |
...
| `test_read_progress.py` | 49 | The read, as it happens. |
...
| `test_suggested_anchors.py` | 37 | The screenplay proposes the look, and colour leaves step 01. |
