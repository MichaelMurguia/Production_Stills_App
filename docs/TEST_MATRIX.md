...
**2040 tests** across 110 files.


## Product app — 1819 tests in 93 files
...
| `test_first_user_test_stop1.py` | 20 | Stop 1 of the first-user-test plan: nothing is lost, nothing refuses silently. |
